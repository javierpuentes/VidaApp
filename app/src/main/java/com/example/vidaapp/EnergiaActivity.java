...
public class EnergiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipoServ = 3; //1=gas, 2=agua, 3= energia
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(EnergiaActivity.this, "¡Serequieren los datos obligatorios de la factura!", Toast.LENGTH_SHORT).show();
                }
                else
                {
        ...
        sp1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    {
                        Toast.makeText(EnergiaActivity.this, "¡No posee registros almacenados de este servicio!", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
    ...
    public void llenarTabla(String mes, double consumo, double precio, int year){
        TableRow fila = new TableRow(EnergiaActivity.this);
        //MES
        TextView celdam = new TextView(EnergiaActivity.this);
        celdam.setText(mes);
        celdam.setWidth(250);
        ...
        //CONSUMO
        TextView celdac = new TextView(EnergiaActivity.this);
        ...
        //PRECIO
        TextView celdap = new TextView(EnergiaActivity.this);
        ...
        //AÑO
        TextView celday = new TextView(EnergiaActivity.this);
        celday.setText("" + year);
        celday.setWidth(100);
    ...
    public void promedios() {
         ...
         */
        rm1.setText(formato.format(vl1)+" kWh");
        rm2.setText("$ "+vl2);
        rm3.setText(formato.format(vl1/filas)+" kWh");

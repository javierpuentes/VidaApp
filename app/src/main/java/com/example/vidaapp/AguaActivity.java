...
public class AguaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipoServ = 2; //1=gas, 2=agua, 3= energia
        ...
        im2 = findViewById(R.id.imgbtngas);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AguaActivity.this, "¡Serequieren los datos obligatorios de la factura!", Toast.LENGTH_SHORT).show();
                }
                else
                {
        ...
        sp1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    {
                        Toast.makeText(AguaActivity.this, "¡No posee registros almacenados de este servicio!", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
    ...
    public void llenarTabla(String mes, double consumo, double precio, int year){
        TableRow fila = new TableRow(AguaActivity.this);
        //MES
        TextView celdam = new TextView(AguaActivity.this);
        celdam.setText(mes);
        celdam.setWidth(250);
        ...
        //CONSUMO
        TextView celdac = new TextView(AguaActivity.this);
        ...
        //PRECIO
        TextView celdap = new TextView(AguaActivity.this);
        ...
        //AÑO
        TextView celday = new TextView(AguaActivity.this);
        celday.setText("" + year);
        celday.setWidth(100);
